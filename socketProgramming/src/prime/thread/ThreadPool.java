...
public class ThreadPool
{
	 ...
	 * @param The numOfThreads is a paramter with value of
     *  number of thread in a thread pool
	 * @param The FileProcessor object "fp" for performing file
	 *  operations
	 * @param The Results object "results" for storing the prime
	 *  numbers
	 * @param The IsPrime object "isPrime" for checking if a
	 *  number is prime
	 */
	public static void createThreads(int numOfThreads, FileProcessor fp, Results results, IsPrime isPrime)
	{
		...
		{
			addThread(new Thread(new WorkerThread(fp, isPrime, results)));
		}
	}
